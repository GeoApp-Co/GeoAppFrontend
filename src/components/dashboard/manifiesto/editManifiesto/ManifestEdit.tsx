        ...
        <Disclosure as="div" className="">
                ...
                <DisclosurePanel className="px-4 pt-4 pb-2 text-sm text-gray-700">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-1 text-sm text-gray-700">
                        ...
                        <div><strong>Fecha Inicial:</strong> {formatDateTimeLarge(data.date)}</div>
                        <div><strong>Fecha Final:</strong> {formatDateTimeLarge(data.dateFinal)}</div>
                        <div><strong>Placa Del Vehículo:</strong> {data.plate}</div>
                        <div><strong>Observaciones:</strong> {data.observations || "Ninguna"}</div>
                    </div>
                </DisclosurePanel>
        </Disclosure>
